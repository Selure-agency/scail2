...
# Install the full CUDA 12.8 development toolkit. The base image ships only a
...
# NOTE: this must match the CUDA version this container's PyTorch was actually
# built against (12.8) — not necessarily the same version as any other pod or
# container, confirmed by a real version-mismatch build failure.
